...
Share Your Waste Recycling Trash and get rewarded with <b>Hedera Cryprto Currency</b>
...
<br><br>
 ...
 <div class="form-group">
              ...
              <input type="text" class="col-sm-12 form-control" id="pickup_address" name="pickup_address" placeholder="Trash Pickup Address">
            </div>
...
<center><h3>Hi!
<b style='color:purple'> <?php echo $fullname_sess; ?> (<?php echo $status_sess; ?>), Welcome to your Waste Managements Contribution Profile</b></h3></center><br>
...
alert('Your Hedera Private Key Id is Empty');
}
...
var datasend = {token_id:token_id, private_key:private_key};
		...
		$.ajax({
			...
			type:'POST',
                        dataType: 'json',
			url:'<?php echo $nodejs_url; ?>/users/balance2',
			data:datasend,
                        crossDomain: true,
			cache:false,
			success:function(msg){
...
//$('#em').val('');		
 ...
 <div class="form-group col-sm-4">
              <label> Enter your Hedera Private Key: </label>
              <input type="text" class="col-sm-4 form-control" id="private_key" name="private_key" placeholder="Enter your Hedera Private Key">
            </div>
<br><br>
...
<img style="max-height:100px;max-width:100px;" class="img-circle" width="100px" height="100px" src="uploads/<?php echo $photo_sess; ?>" width="80px" height="80px">
<br>
...
Total Reward Earned: <?php echo $total_rewards ?>(hbars) </b><br>
...
<center><h3>Your Shared Recycled Waste Materials Over Time</h3></center><br>
...
<center><h3>Your Shared Compostable Waste Materials Over Time</h3></center><br>
...
$('.loader_res').fadeIn(400).html('<br><div style="background:#eee; width:100%;height:30%;text-align:center"><img src="ajax-loader.gif">&nbsp;Please Wait, Your Data is being Loaded</div>');
 ...
 var data_initialize = $('#backup_contentx').DataTable({
  ...
  "order":[],
  "ajax":{
   url:"profile_base_action_composting.php",
   type:"POST",
   data:{get_content:get_content}
  },
  "columnDefs":[
