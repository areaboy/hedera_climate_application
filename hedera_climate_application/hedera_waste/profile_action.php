...
$userid_sess =  htmlentities(htmlentities($_POST["userid"], ENT_QUOTES, "UTF-8"));
...
// get total count
//$pstmt = $db->prepare('SELECT * FROM recycling');
//$pstmt->execute();
//$total_count = $pstmt->rowCount();

$pstmt = $db->prepare('SELECT * FROM recycling where userid=:userid');
...
$sql_query .= "SELECT * FROM recycling ";
...
$waste_approval= "
<button id='' style='display:none;' disabled title='Mark Waste as Collected & Awards Points' class='approve_btn  btn btn-primary btn-xs'
 data-id='$id'
 data-userid='$userid'
...
data-info='$info'
data-glass='$glass'
data-paper_card='$paper_card'
data-metals='$metals'
data-plastic='$plastic'
data-textiles='$textiles'
data-weee_metals='$weee_metals'
data-iba_metals='$iba_metals'
data-other='$other'
data-timing1='$timing'
...
<button id='' style='display:none;' disabled title='Delete' class='delete_btn btn btn-danger btn-xs'
 data-id='$id'
 data-userid='$userid'
 >
 Delete</button>
